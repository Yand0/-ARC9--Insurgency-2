...
SWEP.Trivia = {
    ...
    Manufacturer = "USMC Precision Weapons Shop",
    Calibre = ".45 ACP",
    Mechanism = "Blowback",
...
SWEP.Description = [[M45A1 is a magazine-fed, recoil-operated, semi-automatic pistol chambered for the .45 ACP cartridge.]]

SWEP.ViewModel = "models/weapons/ins/m45/v_m45.mdl"
...
SWEP.CustomizePos = Vector(12, 20, 2)
...
SWEP.ShellModel = "models/weapons/ins/shells/45apc.mdl"
...
SWEP.DryFireSound = "weapons/m45/m45_empty.wav"
...
SWEP.Attachments = {
	{
	    PrintName = "Magazine",
		DefaultName = "7rnd mag",
        Bone = "Magazine",
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, -90, 0),
        Category = {"ins2_m45pistolmags"},
		Integral = true
	},
	{
	    PrintName = "Tacticals",
