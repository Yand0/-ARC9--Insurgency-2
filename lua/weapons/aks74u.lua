...
SWEP.Description = [[The AKS-74U is a short version of an AK-74, designed by small arms designer Mikhail Kalashnikov in 1974.]]

SWEP.ViewModel = "models/weapons/ins/aks74u/v_aks74u.mdl"
...
SWEP.DamageMax = 82 -- Damage done at point blank range
...
local path = "weapons/aks74u/aks_"
...
SWEP.DryFireSound = "weapons/aks74u/aks_empty.wav"
SWEP.DistantShootSoundSilenced = path .. "weapons/universal/null.wav"

SWEP.DryFireSingleAction = true

SWEP.TriggerDownSound = "weapons/aks74u/aks_fireselect_1.wav"
SWEP.TriggerUpSound = ""
...
SWEP.Attachments = {
	{
        ...
        Category = {"ins2_aksuhandguard"},
        Bone = "A_Underbarrel",
        Pos = Vector(-3.95, -0.48, 0.28),
        Ang = Angle(0, 0, 90),
		Integral = true
    },
	{
	    PrintName = "Irons",
		DefaultName = "RIS Mount",
        Bone = "A_Optic",
        Pos = Vector(0, -0.15, 0),
        Ang = Angle(90, 90, 0),
        Category = {"ins2_aksudustcover"},
	},
	{
        ...
        Bone = "A_Optic",
        Pos = Vector(0, 0, -0.5),
		RequireElements = {"ins2_aksudustcover"},
        Ang = Angle(90, 90, 0),
        Category = {"ins2_aksurisoptics"},
	},
	{
	    PrintName = "RIS Right",
		DefaultName = "Rail",
        Bone = "A_LaserFlashlight",
        Pos = Vector(-2.5, -1.05, -0.15),
		RequireElements = {"ins_aksurishandguard"},
        Ang = Angle(0, 0, 0),
	...
	{
	    PrintName = "AKS-74U Barrel Mount",
