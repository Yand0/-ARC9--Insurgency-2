...
SWEP.Description = [[The M16A4 rifle is a selective-fire rifle chambered in 5.56×45mm NATO used by many militaries around the world.]]

SWEP.ViewModel = "models/weapons/ins/m16a4/v_m16a3.mdl"
...
SWEP.Attachments = {
	{
        ...
        Pos = Vector(0, 0, 0),
        Ang = Angle(90, 90, 0),
        Category = {"ins2_m16optics", "ins2_m16risoptics"},
		Integral = true
	},
	{
	    PrintName = "RIS Right",
        ...
        Pos = Vector(-0.7, -0.25, 0),
        Ang = Angle(0, 0, 0),
        Category = {"ins2_m4railleftright", "ins2_m4railleftrighttop"},
	},
	{
	    PrintName = "RIS Bottom",
		DefaultName = "Rail",
        Bone = "A_Underbarrel",
        Pos = Vector(-10.5, -1.5, 1),
        Ang = Angle(0, 0, 0),
        Category = {"ins2_m16underbarrel", "ins2_m16lilcovers"},
	},
	{
	    PrintName = "RIS Top",
		DefaultName = "Rail",
        ...
        Category = {"ins2_m16rail", "ins2_m4railleftrighttop"},
	},
	{
	    PrintName = "Muzzle",
		DefaultName = "Muzzle brake",
        Bone = "Weapon",
        Pos = Vector(0, 18, 2.55),
        Ang = Angle(180, 90, 0),
