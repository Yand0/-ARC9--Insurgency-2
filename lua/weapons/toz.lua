...
SWEP.Description = [[TOZ-194 is a pump-action shotgun manufactured by the Tula Arms Plant. ]]

SWEP.ViewModel = "models/weapons/ins/toz/v_toz.mdl"
...
SWEP.ShootSound = "weapons/toz_shotgun/toz_fp.wav"
...
SWEP.MuzzleParticle = "muzzleflash_toz_1p" -- Used for some muzzle effects.
