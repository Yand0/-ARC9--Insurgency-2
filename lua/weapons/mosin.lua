...
SWEP.ShootSound = "weapons/mosin/mosin_fp.wav"
SWEP.DistantShootSound = "weapons/mosin/mosin_dist.wav"

SWEP.DryFireSound = "weapons/mosin/mosin_empty.wav"
...
local path = "weapons/mosin/mosin_"
...
SWEP.Animations = {
    ...
    ["reload_insert"] = { Source = "reload_insert", Mult = 0.75, MinProgress = 0.5, MagSwapTime = 0.5, EventTable = {
        {t = 14 / 35.5, s = bulletin},
    } },
    ["reload_finish"] = { Source = "reload_end", EventTable = {
