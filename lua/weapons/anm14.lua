...
SWEP.Description = [[The AN-M14 is a purpose designed incendiary grenade intended for damaging or destroying materiel such as vehicles, shelters, weapon systems, or munitions.]]

SWEP.ViewModel = "models/weapons/ins/anm14/v_anm14.mdl"
...
SWEP.ShootEnt = "ins_anm14inc_thrown" -- Set to an entity to launch it out of this weapon.
...
SWEP.Animations = {
    ...
    ["draw"] = {
        Source = "base_draw",
        EventTable = {
            {s = "universal/uni_grenade_draw_01.wav", t = 0}
        }
    },
    ["holster"] = {
        Source = "base_holster",
        EventTable = {
            {s = "universal/uni_grenade_holster.wav", t = 0}
        }
    },
    ["pullpin"] = {
