...
SWEP.Class = "Bladed melee, utility tool"
SWEP.Trivia = {
    Designer = "Gorkha Kingdom",
    Manufacturer = "Middle east knife master",
    Mechanism = "Stab and slash",
    Origin = "Gorkha Kingdom",
    Year = "~1600",
}

SWEP.PrintName = "Khukri"
SWEP.TrueName = "Gurkha"
...
SWEP.ViewModel = "models/weapons/ins/khukri/v_gurkha.mdl"
