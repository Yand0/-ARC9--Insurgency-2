...
SWEP.Description = [[The British Commonwealth variant of the l1a1. Was produced under licence as the L1A1 Self-Loading Rifle.]]

SWEP.ViewModel = "models/weapons/ins/l1a1/v_l1a1.mdl"
...
SWEP.SprintVerticalOffset = l1a1se -- Moves vm when looking up/down while sprinting (set to l1a1se if gun clips into camera)
SWEP.ReloadNoSprintPos = l1a1se -- No sprintpos during reloads
...
SWEP.AnimDraw = l1a1se

-------------------------- EFFECTS

SWEP.MuzzleParticle = "muzzleflash_fal_1p" -- Used for some muzzle effects.
...
SWEP.DryFireSound = "weapons/fnfal/fnfal_empty.wav"

SWEP.DryFireSingleAction = true

SWEP.TriggerDownSound = "weapons/fnfal/fnfal_fireselect_1.wav"
SWEP.TriggerUpSound = ""
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "boltrelease.wav", t = 100 / 30},
        },
        IKTimeLine = {
            {
                t = 0,
