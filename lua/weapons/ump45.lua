...
SWEP.Description = [[The UMP-45 is a blowback-operated, magazine-fed submachine gun developed and manufactured by Heckler & Koch.]]

SWEP.ViewModel = "models/weapons/ins/ump45/v_ump45.mdl"
...
SWEP.MuzzleParticle = "muzzleflash_ump_1p" -- Used for some muzzle effects.
...
SWEP.DryFireSound = "weapons/ump45/ump45_empty.wav"
...
SWEP.FiremodeSound = path .. "fireselect.wav"
