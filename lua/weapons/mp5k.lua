...
SWEP.Description = [[The MP5k is a variant of the German MP5 submachine gun developed in the 1980s, fires the same 9×19 Parabellum round used in the standard MP5]]

SWEP.ViewModel = "models/weapons/ins/mp5k/v_mp5kpdw.mdl"
...
SWEP.MuzzleParticle = "muzzleflash_mp5_1p" -- Used for some muzzle effects.
...
SWEP.DryFireSound = "weapons/mp5k/mp5k_empty.wav"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
		    {s = common .. "weapon_draw_01.wav", t = 0 / 30},
            {s = path .. "boltrelease.wav", t = 15 / 30},
        },
        IKTimeLine = {
            {
                t = 0,
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "boltlock.wav", t = 15 / 30},
		    {s = path .. "magrelease.wav", t = 34 / 30},
            {s = path .. "magout.wav", t = 39 / 30},
            {s = path .. "magin.wav", t = 90 / 30},
...
SWEP.Attachments = {
	{
        PrintName = "Stock",
		DefaultName = "None",
        Category = {"ins2_mp5pdwstock"},
        Bone = "A_Optic",
        Pos = Vector(0, -1.35, -4.5),
        Ang = Angle(180, 0, 90),
    },
	{
	    PrintName = "RIS Mount",
