...
SWEP.Description = [[Makarov pistol is a Soviet semi-automatic pistol chambered in 9×18mm.]]

SWEP.ViewModel = "models/weapons/ins/makarov/v_makarov.mdl"
...
SWEP.MuzzleParticle = "muzzleflash_makarov_1p" -- Used for some muzzle effects.
...
local path = "weapons/makarov/makarov_"
...
SWEP.TriggerDownSound = "weapons/makarov/makarov_fireselect_1.wav"
SWEP.TriggerUpSound = ""
...
SWEP.Attachments = {
	{
	    PrintName = "Magazine",
		DefaultName = "8rnd mag",
        Bone = "Magazine",
        Pos = Vector(0, 0, 0),
        Ang = Angle(0, -90, 0),
        Category = {"ins2_pistolmags"},
		Integral = true
	},
	{
	    PrintName = "Tacticals",
