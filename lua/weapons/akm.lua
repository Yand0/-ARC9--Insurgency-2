...
"[Default]XQAAAQBoAAAAAAAAAAA9iIIiM7tuo1A+gSftjOuJJvjHoFFqPQDcJh9upVWKjyN5QC68fScjOeKwdg9dH5FLDNS+2gBNKocUZ03BimpbKfjpgzmCqgA="
}

SWEP.Description = [[The AKM is a 7.62mm assault rifle designed by Mikhail Kalashnikov. The AKMS variant comes with a foldable MP40-like stock]]

SWEP.ViewModel = "models/weapons/ins/akm/v_akm.mdl"
...
SWEP.RecoilSide = 1.7 -- Multiplier for vertical recoil

SWEP.RecoilPatternDrift = 5

SWEP.RecoilMultHipFire = 0.9
...
SWEP.DryFireSound = "weapons/ak47/ak47_empty.wav"
SWEP.DistantShootSoundSilenced = path .. "weapons/universal/null.wav"

SWEP.DryFireSingleAction = true

SWEP.TriggerDownSound = "weapons/ak47/ak47_fireselect_1.wav"
SWEP.TriggerUpSound = ""
...
SWEP.Attachments = {
	{
        ...
        Category = {"ins2_akmhandguard"},
        Bone = "A_Underbarrel",
        Pos = Vector(-5.8, -0.45, 0.95),
        Ang = Angle(0, 0, 90),
		Integral = true
    },
	{
	    PrintName = "Dustcover",
		DefaultName = "Dustcover",
        Bone = "A_Optic",
        Pos = Vector(0, 0, 0),
        Ang = Angle(90, 90, 0),
	...
	},
	{
        ...
        Ang = Angle(90, 90, 0),
        Category = {"ins2_akmrisoptics"},
	},
	{
	    PrintName = "RIS Right",
		DefaultName = "Rail",
        Bone = "A_LaserFlashlight",
        Pos = Vector(-5.8, -0.95, -0.3),
		RequireElements = {"ins_akmrishandguard"},
        Ang = Angle(0, 0, 0),
	...
	},
	{
		...
		DefaultName = "Rail",
        Bone = "A_LaserFlashlight",
        Pos = Vector(-5.8, 0.95, -0.25),
		RequireElements = {"ins_akmrishandguard"},
        Ang = Angle(-180, -180, 0),
        Category = {"ins2_m4railleftright"},
	},
	{
	    PrintName = "AKM Barrel Mount",
