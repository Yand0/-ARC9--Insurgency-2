...
ENT.Model = "models/weapons/ins/f1/w_f1.mdl"
ENT.PhysMat = "grenade"

ENT.LifeTime = 5

ENT.ExplodeOnImpact = false
ENT.Decal							 =	"materials/decals/scorch_incendiary.vmt"
...
function ENT:Detonate()
    ...
    if self:WaterLevel() > 0 then
        ...
        ParticleEffect("ins_grenade_explosion", self:GetPos(), Angle(0, 0, 0), nil)
