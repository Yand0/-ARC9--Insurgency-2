...
function ENT:Initialize()
    ...
    ParticleEffectAttach("ins_molotov_explosion", PATTACH_ABSORIGIN_FOLLOW, self, 0)
    ParticleEffectAttach("ins_molotov_flame", PATTACH_ABSORIGIN_FOLLOW, self, 0)
    self:EmitSound("weapons/molotovins/molotov_burn.wav", 75, 100, 1, CHAN_AUTO)
