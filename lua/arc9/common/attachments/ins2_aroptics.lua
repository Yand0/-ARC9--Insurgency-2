...
ATT.PrintName = "M16A4 Carry Handle"
ATT.CompactName = "Carry Handle"
ATT.Icon = Material("entities/ch.png", "mips smooth")
ATT.Description = [[Standard issue M16A4 Carry handle]]
ATT.MenuCategory = "ARC9 - Insurgency 2"
ATT.Category = "ins2_m16optics"

ATT.Model = "models/weapons/ins/upgrades/a_carryhandle_m4.mdl"
ATT.ModelOffset = Vector(-10.5, -2.35, 1.4)

ARC9.LoadAttachment(ATT, "ins2_m16carryhandle")
----------------------------------------------------------------
ATT = {}

ATT.PrintName = "M16A4 Flip-Up irons"
ATT.CompactName = "Flip-Up Irons"
ATT.Icon = Material("entities/m40flipup.png", "mips smooth")
ATT.Description = [[Standard issue M16A4 Flip-Up Irons]]
ATT.MenuCategory = "ARC9 - Insurgency 2"
ATT.Category = "ins2_m16optics"
...
ATT.Sights = {
    {
        Pos = Vector(-2.475, -4, 3.2),
        Ang = Angle(0, 0, 0),
    },
}

ARC9.LoadAttachment(ATT, "ins2_m16flipup")
...
ATT.Model = "models/weapons/ins/upgrades/a_standard_mk18.mdl"
ATT.ModelOffset = Vector(-10, -2.52, 1.9)

ATT.Sights = {
    {
        Pos = Vector(-5.02, -11, 4),
        Ang = Angle(0, 0, 0),
    },
}

ARC9.LoadAttachment(ATT, "ins2_mk18irons")